...
def numList(i):
    # Create a program that allows the user to enter in a list of numbers,
    #  prints them out in sorted order,
    #  and prints the sum and average of the numbers.
    # Prompt the user to continue entering numbers,
